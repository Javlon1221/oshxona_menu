        ...
        <div className="min-h-screen bg-[color:var(--brand-bg)]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
                    <div>
                        <h2 className="text-3xl font-bold text-[color:var(--brand-primary)] mb-6">
                            Bizning hikoyamiz
                        </h2>
                    ...
                    <div className="relative">
                        <img
                            ...
                            className="w-full h-96 object-cover rounded-2xl shadow-lg ring-1 ring-black/10"
                        />
                    </div>
                </div>
                ...
                {/* Values Section */}
                <div className="mb-16">
                    <h2 className="text-3xl font-bold text-[color:var(--brand-primary)] text-center mb-12">
                        Bizning qadriyatlarimiz
                    </h2>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="text-center">
                            <div className="w-16 h-16 bg-[color:var(--brand-secondary)] rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
                        ...
                        <div className="text-center">
                            <div className="w-16 h-16 bg-[color:var(--brand-accent)] rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
                                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="text-center">
                            <div className="w-16 h-16 bg-[color:var(--brand-primary)] rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
                                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="mb-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={index} className="bg-white/80 backdrop-blur border border-black/10 rounded-2xl shadow-md p-6 text-center">
                                <div className="w-20 h-20 bg-[color:var(--brand-primary)] rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg ring-1 ring-black/10">
                                    <span className="text-white font-bold text-2xl">
                                        {member.name.charAt(0)}
                                    </span>
                                </div>
                                <h3 className="text-xl font-semibold text-[color:var(--brand-primary)] mb-1">
                                    {member.name}
                                </h3>
                                <p className="text-[color:var(--brand-accent)] font-medium mb-2">
                                    {member.position}
                                </p>
                ...
                {/* Stats Section */}
                <div className="bg-[color:var(--brand-primary)] rounded-2xl p-8 text-white text-center shadow-lg ring-1 ring-black/10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        ...
                        <div>
                            ...
                            <div className="text-white/80">Muntazam mijozlar</div>
                        </div>
                        <div>
                            <div className="text-4xl font-bold mb-2">50+</div>
                            <div className="text-white/80">Turli taomlar</div>
                        </div>
                        <div>
                            <div className="text-4xl font-bold mb-2">24/7</div>
                            <div className="text-white/80">Xizmat ko'rsatish</div>
                        </div>
                    </div>
                </div>
            </div>
